...
<body>
    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          <td><a href="<?= "information/index/" . $this->nettoyer($information['id']) ?>"> <p class="titreJeu"><?= $this->nettoyer($information['titre']) ?></p> </a></td> 
          <td>
            <form method="post" action="ainformation/deleteInformation">
                <input type="hidden" name="id" value="<?= $information['id'] ?>" />
                <input type="submit" name="supprimer" value="supprimer" class="btn btn-outline-danger btn-sm" />
            </form>  
          </td>
          <td>
            <form method="post" action="minformation">
                <input type="hidden" name="id" value="<?= $information['id'] ?>" />
