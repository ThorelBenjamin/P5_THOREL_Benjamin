        ...
        <div class="container">
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  <td><a href="<?= "billet/index/" . $this->nettoyer($billet['id']) ?>"> <p class="titreBillet"><?= $this->nettoyer($billet['titre']) ?></p> </a></td>
                  <td>
                    <form method="post" action="aevenement/deletes">
                        <input type="hidden" name="id" value="<?= $billet['id'] ?>" />
                        <input type="submit" name="supprimer" value="supprimer" class="btn btn-outline-danger btn-sm" />
                    </form>  
                  </td>
                  <td>
                    <form method="post" action="Mevenement">
                        <input type="hidden" name="id" value="<?= $billet['id'] ?>" />
